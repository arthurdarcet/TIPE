...
Gc.set { (Gc.get()) with Gc.stack_limit = 100_000_000 };;				(* Evite les stack_overflow quand compilé avec ocamlc	*)

let compil cin cout taux_compress dist_coul =							(* cin et cout sont des string représentant le chemin d'accès au fichier en entrée et en sortie *)
	print_newline ();
...
let cin = ref "" and cout = ref "" and taux_compress = ref 1. and dist_coul = ref 1;;
...
compil (!cin) (!cout) (!taux_compress) (!dist_coul);;
